...
echo "Verificando estado de los componentes..."
kubectl get pods -n gatekeeper-system
kubectl get svc -n gatekeeper-system
echo "------------------------------------------------------"

echo "Pruebas Negativas: Intentando desplegar recursos prohibidos..."
...
echo "------------------------------------------------------"
echo "Prueba Positiva: Desplegando recurso válido (Golden Pod)..."
echo -n "Probando examples/golden-pod.yaml ... "
kubectl apply -f examples/golden-pod.yaml
...
echo "------------------------------------------------------"
echo "Todas las pruebas pasaron exitosamente. El clúster está seguro."
